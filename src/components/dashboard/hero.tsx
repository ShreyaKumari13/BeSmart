...
//             console.log('Input values:', { searchInput, searchType, category });
...
//             const redirectUrl = `/results?id=${data.id}&query=${encodeURIComponent(searchInput)}&type=${encodeURIComponent(searchType)}&category=${encodeURIComponent(category)}`;
...
//                         </p>
//                         <form onSubmit={handleAnalyze} className="flex flex-col items-center gap-2 max-w-4xl mx-auto bg-white/5 backdrop-blur-sm rounded-lg p-4">
...
//                     <p className={`${raleway.className} text-sm text-white/80 mt-4`}>
//                         {query ? (
